...
compressed_image.save(f'{filename}_compressed.jpg')

original_size = os.path.getsize(f'{filename}.jpg')
compressed_size = os.path.getsize(f'{filename}_compressed.jpg')
